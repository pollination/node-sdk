 ...
 * @export
 * @interface AppModulesProjectsDtoSimulationArgumentArtifact
 */
export interface AppModulesProjectsDtoSimulationArgumentArtifact {
    /**
     * The name of the artifact
     * @type {string}
     * @memberof AppModulesProjectsDtoSimulationArgumentArtifact
     */
    name: string;
    /**
     * 
 ...
 * @export
 * @interface AppModulesProjectsDtoSimulationArguments
 */
export interface AppModulesProjectsDtoSimulationArguments {
    /**
     * A list of input parameters
     * @type {Array<ArgumentParameter>}
     * @memberof AppModulesProjectsDtoSimulationArguments
     */
    parameters?: Array<ArgumentParameter>;
    /**
     * A list of input artifacts
     * @type {Array<AppModulesProjectsDtoSimulationArgumentArtifact>}
     * @memberof AppModulesProjectsDtoSimulationArguments
     */
    artifacts?: Array<AppModulesProjectsDtoSimulationArgumentArtifact>;
}
/**
 ...
 * @enum {string}
 */
export enum ProjectPolicyPermissionEnum {
    Admin = 'admin',
 ...
 * A workflow Artifact Argument
 * @export
 * @interface QueenbeeWorkflowArgumentsArgumentArtifact
 */
export interface QueenbeeWorkflowArgumentsArgumentArtifact {
    /**
     * The name of the artifact
     * @type {string}
     * @memberof QueenbeeWorkflowArgumentsArgumentArtifact
     */
    name: string;
    /**
     * 
 ...
 * Workflow Arguments
 * @export
 * @interface QueenbeeWorkflowArgumentsArguments
 */
export interface QueenbeeWorkflowArgumentsArguments {
    /**
     * A list of input parameters
     * @type {Array<ArgumentParameter>}
     * @memberof QueenbeeWorkflowArgumentsArguments
     */
    parameters?: Array<ArgumentParameter>;
    /**
     * A list of input artifacts
     * @type {Array<QueenbeeWorkflowArgumentsArgumentArtifact>}
     * @memberof QueenbeeWorkflowArgumentsArguments
     */
    artifacts?: Array<QueenbeeWorkflowArgumentsArgumentArtifact>;
}
/**
 * A Queenbee Recipe
 * @export
...
export interface SubmitSimulationDto {
    ...
    /**
     * Simulation inputs
     * @type {AppModulesProjectsDtoSimulationArguments}
     * @memberof SubmitSimulationDto
     */
    inputs?: AppModulesProjectsDtoSimulationArguments;
}
/**
...
export interface TaskStatus {
     ...
     * @type {QueenbeeWorkflowArgumentsArguments}
     * @memberof TaskStatus
     */
    inputs: QueenbeeWorkflowArgumentsArguments;
    /**
     * The outputs produced by this task
     * @type {QueenbeeWorkflowArgumentsArguments}
     * @memberof TaskStatus
     */
    outputs: QueenbeeWorkflowArgumentsArguments;
    /**
...
export const AccountsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        listAccounts(page?: number, perPage?: number, search?: string, type?: string, options: any = {}): RequestArgs {
...
export const AccountsApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        listAccounts(page?: number, perPage?: number, search?: string, type?: string, options?: any): (axios?: AxiosInstance, basePath?: string) => AxiosPromise<PublicAccountList> {
            const localVarAxiosArgs = AccountsApiAxiosParamCreator(configuration).listAccounts(page, perPage, search, type, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
export const AccountsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        listAccounts(page?: number, perPage?: number, search?: string, type?: string, options?: any) {
            return AccountsApiFp(configuration).listAccounts(page, perPage, search, type, options)(axios, basePath);
        },
    };
};
...
export class AccountsApi extends BaseAPI implements AccountsApiInterface {
    ...
    public listAccounts(page?: number, perPage?: number, search?: string, type?: string, options?: any) {
        return AccountsApiFp(this.configuration).listAccounts(page, perPage, search, type, options)(this.axios, this.basePath);
    }
...
export const ArtifactsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        downloadArtifact(owner: string, name: string, path?: string, options: any = {}): RequestArgs {
            // verify required parameter 'owner' is not null or undefined
            if (owner === null || owner === undefined) {
...
export const ArtifactsApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        downloadArtifact(owner: string, name: string, path?: string, options?: any): (axios?: AxiosInstance, basePath?: string) => AxiosPromise<any> {
            const localVarAxiosArgs = ArtifactsApiAxiosParamCreator(configuration).downloadArtifact(owner, name, path, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
export const ArtifactsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        downloadArtifact(owner: string, name: string, path?: string, options?: any) {
            return ArtifactsApiFp(configuration).downloadArtifact(owner, name, path, options)(axios, basePath);
        },
        /**
         * Retrieve a list of artifacts.
         * @summary List artifacts in a project folder
...
export class ArtifactsApi extends BaseAPI implements ArtifactsApiInterface {
    ...
    public downloadArtifact(owner: string, name: string, path?: string, options?: any) {
        return ArtifactsApiFp(this.configuration).downloadArtifact(owner, name, path, options)(this.axios, this.basePath);
    }
...
export const OperatorsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        getOperatorByTag(owner: string, name: string, tag: string, options: any = {}): RequestArgs {
            // verify required parameter 'owner' is not null or undefined
            if (owner === null || owner === undefined) {
         ...
         * @throws {RequiredError}
         */
        listOperatorTags(owner: string, name: string, options: any = {}): RequestArgs {
            // verify required parameter 'owner' is not null or undefined
            if (owner === null || owner === undefined) {
...
export const OperatorsApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        createOperatorPackage(owner: string, name: string, newOperatorPackage: NewOperatorPackage, options?: any): (axios?: AxiosInstance, basePath?: string) => AxiosPromise<PackageDto> {
         ...
         * @throws {RequiredError}
         */
        getOperator(owner: string, name: string, options?: any): (axios?: AxiosInstance, basePath?: string) => AxiosPromise<RepositoryDto> {
         ...
         * @throws {RequiredError}
         */
        getOperatorByTag(owner: string, name: string, tag: string, options?: any): (axios?: AxiosInstance, basePath?: string) => AxiosPromise<OperatorPackage> {
            const localVarAxiosArgs = OperatorsApiAxiosParamCreator(configuration).getOperatorByTag(owner, name, tag, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        listOperatorTags(owner: string, name: string, options?: any): (axios?: AxiosInstance, basePath?: string) => AxiosPromise<PackageListDto> {
            const localVarAxiosArgs = OperatorsApiAxiosParamCreator(configuration).listOperatorTags(owner, name, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
export const OperatorsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        getOperatorByTag(owner: string, name: string, tag: string, options?: any) {
            return OperatorsApiFp(configuration).getOperatorByTag(owner, name, tag, options)(axios, basePath);
        },
        /**
         * Retrieve an operator by name
         * @summary Get an operator tags
         ...
         * @throws {RequiredError}
         */
        listOperatorTags(owner: string, name: string, options?: any) {
            return OperatorsApiFp(configuration).listOperatorTags(owner, name, options)(axios, basePath);
        },
        /**
         * 
         * @summary List operators
...
export interface OperatorsApiInterface {
     ...
     * @memberof OperatorsApiInterface
     */
    createOperatorPackage(owner: string, name: string, newOperatorPackage: NewOperatorPackage, options?: any): AxiosPromise<PackageDto>;
...
export class OperatorsApi extends BaseAPI implements OperatorsApiInterface {
    ...
    public getOperatorByTag(owner: string, name: string, tag: string, options?: any) {
        return OperatorsApiFp(this.configuration).getOperatorByTag(owner, name, tag, options)(this.axios, this.basePath);
    }
    ...
    public listOperatorTags(owner: string, name: string, options?: any) {
        return OperatorsApiFp(this.configuration).listOperatorTags(owner, name, options)(this.axios, this.basePath);
    }
...
export const OrgsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {string} name 
         * @param {string} username 
         * @param {OrgRoleEnum} role 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        upsertOrgMember(name: string, username: string, role: OrgRoleEnum, options: any = {}): RequestArgs {
            // verify required parameter 'name' is not null or undefined
            if (name === null || name === undefined) {
...
export const OrgsApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        getOrg(name: string, options?: any): (axios?: AxiosInstance, basePath?: string) => AxiosPromise<OrgDto> {
         ...
         * @throws {RequiredError}
         */
        upsertOrgMember(name: string, username: string, role: OrgRoleEnum, options?: any): (axios?: AxiosInstance, basePath?: string) => AxiosPromise<UpdateAccepted> {
...
export const OrgsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        upsertOrgMember(name: string, username: string, role: OrgRoleEnum, options?: any) {
...
export interface OrgsApiInterface {
     ...
     * @memberof OrgsApiInterface
     */
    getOrg(name: string, options?: any): AxiosPromise<OrgDto>;
     ...
     * @memberof OrgsApiInterface
     */
    upsertOrgMember(name: string, username: string, role: OrgRoleEnum, options?: any): AxiosPromise<UpdateAccepted>;
...
export class OrgsApi extends BaseAPI implements OrgsApiInterface {
     ...
     * @memberof OrgsApi
     */
    public upsertOrgMember(name: string, username: string, role: OrgRoleEnum, options?: any) {
...
export const ProjectsApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        getProject(owner: string, name: string, options?: any): (axios?: AxiosInstance, basePath?: string) => AxiosPromise<ProjectDto> {
...
export const RecipesApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        getRecipeByTag(owner: string, name: string, tag: string, options: any = {}): RequestArgs {
            // verify required parameter 'owner' is not null or undefined
            if (owner === null || owner === undefined) {
         ...
         * @throws {RequiredError}
         */
        listRecipeTags(owner: string, name: string, options: any = {}): RequestArgs {
            // verify required parameter 'owner' is not null or undefined
            if (owner === null || owner === undefined) {
...
export const RecipesApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        createRecipePackage(owner: string, name: string, newRecipePackage: NewRecipePackage, authorization?: string, options?: any): (axios?: AxiosInstance, basePath?: string) => AxiosPromise<PackageDto> {
         ...
         * @throws {RequiredError}
         */
        getRecipe(owner: string, name: string, options?: any): (axios?: AxiosInstance, basePath?: string) => AxiosPromise<RepositoryDto> {
         ...
         * @throws {RequiredError}
         */
        getRecipeByTag(owner: string, name: string, tag: string, options?: any): (axios?: AxiosInstance, basePath?: string) => AxiosPromise<RecipePackage> {
            const localVarAxiosArgs = RecipesApiAxiosParamCreator(configuration).getRecipeByTag(owner, name, tag, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        listRecipeTags(owner: string, name: string, options?: any): (axios?: AxiosInstance, basePath?: string) => AxiosPromise<PackageListDto> {
            const localVarAxiosArgs = RecipesApiAxiosParamCreator(configuration).listRecipeTags(owner, name, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
export const RecipesApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        getRecipeByTag(owner: string, name: string, tag: string, options?: any) {
            return RecipesApiFp(configuration).getRecipeByTag(owner, name, tag, options)(axios, basePath);
        },
        /**
         * Retrieve a recipe by name
         * @summary Get a recipe tags
         ...
         * @throws {RequiredError}
         */
        listRecipeTags(owner: string, name: string, options?: any) {
            return RecipesApiFp(configuration).listRecipeTags(owner, name, options)(axios, basePath);
        },
        /**
         * 
         * @summary List recipes
...
export interface RecipesApiInterface {
     ...
     * @memberof RecipesApiInterface
     */
    createRecipePackage(owner: string, name: string, newRecipePackage: NewRecipePackage, authorization?: string, options?: any): AxiosPromise<PackageDto>;
...
export class RecipesApi extends BaseAPI implements RecipesApiInterface {
    ...
    public getRecipeByTag(owner: string, name: string, tag: string, options?: any) {
        return RecipesApiFp(this.configuration).getRecipeByTag(owner, name, tag, options)(this.axios, this.basePath);
    }
    ...
    public listRecipeTags(owner: string, name: string, options?: any) {
        return RecipesApiFp(this.configuration).listRecipeTags(owner, name, options)(this.axios, this.basePath);
    }
...
export const SimulationsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        downloadSimulationArtifact(owner: string, name: string, simulationId: string, path?: string, options: any = {}): RequestArgs {
            // verify required parameter 'owner' is not null or undefined
            if (owner === null || owner === undefined) {
         ...
         * @throws {RequiredError}
         */
        getSimulationOutputArtifact(owner: string, name: string, simulationId: string, artifactName: string, options: any = {}): RequestArgs {
            // verify required parameter 'owner' is not null or undefined
            if (owner === null || owner === undefined) {
         ...
         * @throws {RequiredError}
         */
        listSimulationArtifacts(owner: string, name: string, simulationId: string, page?: number, perPage?: number, path?: Array<string>, options: any = {}): RequestArgs {
            // verify required parameter 'owner' is not null or undefined
            if (owner === null || owner === undefined) {
         ...
         * @throws {RequiredError}
         */
        stopSimulation(owner: string, name: string, simulationId: string, options: any = {}): RequestArgs {
            // verify required parameter 'owner' is not null or undefined
            if (owner === null || owner === undefined) {
...
export const SimulationsApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        downloadSimulationArtifact(owner: string, name: string, simulationId: string, path?: string, options?: any): (axios?: AxiosInstance, basePath?: string) => AxiosPromise<any> {
            const localVarAxiosArgs = SimulationsApiAxiosParamCreator(configuration).downloadSimulationArtifact(owner, name, simulationId, path, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        listSimulationArtifacts(owner: string, name: string, simulationId: string, page?: number, perPage?: number, path?: Array<string>, options?: any): (axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<FileMeta>> {
            const localVarAxiosArgs = SimulationsApiAxiosParamCreator(configuration).listSimulationArtifacts(owner, name, simulationId, page, perPage, path, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        stopSimulation(owner: string, name: string, simulationId: string, options?: any): (axios?: AxiosInstance, basePath?: string) => AxiosPromise<Accepted> {
            const localVarAxiosArgs = SimulationsApiAxiosParamCreator(configuration).stopSimulation(owner, name, simulationId, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
export const SimulationsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        downloadSimulationArtifact(owner: string, name: string, simulationId: string, path?: string, options?: any) {
            return SimulationsApiFp(configuration).downloadSimulationArtifact(owner, name, simulationId, path, options)(axios, basePath);
        },
        /**
         * Retrieve a simulation.
         * @summary Get a Simulation
         ...
         * @throws {RequiredError}
         */
        getSimulationOutputArtifact(owner: string, name: string, simulationId: string, artifactName: string, options?: any) {
            return SimulationsApiFp(configuration).getSimulationOutputArtifact(owner, name, simulationId, artifactName, options)(axios, basePath);
        },
        /**
         * get simulation outputs
         * @summary Get simulation outputs
         ...
         * @throws {RequiredError}
         */
        listSimulationArtifacts(owner: string, name: string, simulationId: string, page?: number, perPage?: number, path?: Array<string>, options?: any) {
            return SimulationsApiFp(configuration).listSimulationArtifacts(owner, name, simulationId, page, perPage, path, options)(axios, basePath);
        },
        /**
         * Retrieve a list of simulations.
         * @summary List simulations
         ...
         * @throws {RequiredError}
         */
        stopSimulation(owner: string, name: string, simulationId: string, options?: any) {
            return SimulationsApiFp(configuration).stopSimulation(owner, name, simulationId, options)(axios, basePath);
        },
        /**
         * Suspend a simulation.
         * @summary Suspend a simulation
...
export class SimulationsApi extends BaseAPI implements SimulationsApiInterface {
    ...
    public downloadSimulationArtifact(owner: string, name: string, simulationId: string, path?: string, options?: any) {
        return SimulationsApiFp(this.configuration).downloadSimulationArtifact(owner, name, simulationId, path, options)(this.axios, this.basePath);
    }
    ...
    public getSimulationOutputArtifact(owner: string, name: string, simulationId: string, artifactName: string, options?: any) {
        return SimulationsApiFp(this.configuration).getSimulationOutputArtifact(owner, name, simulationId, artifactName, options)(this.axios, this.basePath);
    }
    ...
    public listSimulationArtifacts(owner: string, name: string, simulationId: string, page?: number, perPage?: number, path?: Array<string>, options?: any) {
        return SimulationsApiFp(this.configuration).listSimulationArtifacts(owner, name, simulationId, page, perPage, path, options)(this.axios, this.basePath);
    }
    ...
    public stopSimulation(owner: string, name: string, simulationId: string, options?: any) {
        return SimulationsApiFp(this.configuration).stopSimulation(owner, name, simulationId, options)(this.axios, this.basePath);
    }
...
export const TeamsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        upsertOrgTeamMember(orgName: string, teamSlug: string, username: string, role: TeamRoleEnum, options: any = {}): RequestArgs {
            // verify required parameter 'orgName' is not null or undefined
            if (orgName === null || orgName === undefined) {
...
export const TeamsApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        getTeam(orgName: string, teamSlug: string, options?: any): (axios?: AxiosInstance, basePath?: string) => AxiosPromise<TeamDto> {
         ...
         * @throws {RequiredError}
         */
        upsertOrgTeamMember(orgName: string, teamSlug: string, username: string, role: TeamRoleEnum, options?: any): (axios?: AxiosInstance, basePath?: string) => AxiosPromise<UpdateAccepted> {
...
export const TeamsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        upsertOrgTeamMember(orgName: string, teamSlug: string, username: string, role: TeamRoleEnum, options?: any) {
