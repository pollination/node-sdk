...
export const ArtifactsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        listArtifacts(owner: string, name: string, page?: number, perPage?: number, options: any = {}): RequestArgs {
            // verify required parameter 'owner' is not null or undefined
            if (owner === null || owner === undefined) {
...
export const ArtifactsApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        listArtifacts(owner: string, name: string, page?: number, perPage?: number, options?: any): (axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<FileMeta>> {
            const localVarAxiosArgs = ArtifactsApiAxiosParamCreator(configuration).listArtifacts(owner, name, page, perPage, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
export const ArtifactsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        listArtifacts(owner: string, name: string, page?: number, perPage?: number, options?: any) {
            return ArtifactsApiFp(configuration).listArtifacts(owner, name, page, perPage, options)(axios, basePath);
        },
    };
};
...
export interface ArtifactsApiInterface {
     ...
     * @memberof ArtifactsApiInterface
     */
    listArtifacts(owner: string, name: string, page?: number, perPage?: number, options?: any): AxiosPromise<Array<FileMeta>>;
...
export class ArtifactsApi extends BaseAPI implements ArtifactsApiInterface {
     ...
     * @memberof ArtifactsApi
     */
    public listArtifacts(owner: string, name: string, page?: number, perPage?: number, options?: any) {
        return ArtifactsApiFp(this.configuration).listArtifacts(owner, name, page, perPage, options)(this.axios, this.basePath);
    }
