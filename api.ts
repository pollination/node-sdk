 ...
 * 
 * @export
 * @interface SimulationBaseStatus
 */
export interface SimulationBaseStatus {
    /**
     * The unique ID of the simulation
     * @type {string}
     * @memberof SimulationBaseStatus
     */
    id: string;
    /**
     * The simulation in queenbee workflow status
     * @type {WorkflowStatus}
     * @memberof SimulationBaseStatus
     */
    simulation?: WorkflowStatus;
}
/**
 * A list response from a pagination request
 * @export
...
export interface SimulationList {
    ...
    /**
     * 
     * @type {Array<SimulationBaseStatus>}
     * @memberof SimulationList
     */
    resources: Array<SimulationBaseStatus>;
}
/**
 * 
 * @export
