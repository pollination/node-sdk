...
export const AccountsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {boolean} [exceeded] Whether to return only quotas which are exceeded
         ...
         * @throws {RequiredError}
         */
        listQuotas: async (name: string, type?: Array<QuotaType>, exceeded?: boolean, enforced?: boolean, page?: number, perPage?: number, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'name' is not null or undefined
            if (name === null || name === undefined) {
            ...
            if (exceeded !== undefined) {
                localVarQueryParameter['exceeded'] = exceeded;
            }
...
export const AccountsApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async listQuotas(name: string, type?: Array<QuotaType>, exceeded?: boolean, enforced?: boolean, page?: number, perPage?: number, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<QuotaList>> {
            const localVarAxiosArgs = await AccountsApiAxiosParamCreator(configuration).listQuotas(name, type, exceeded, enforced, page, perPage, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
export const AccountsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        listQuotas(name: string, type?: Array<QuotaType>, exceeded?: boolean, enforced?: boolean, page?: number, perPage?: number, options?: any): AxiosPromise<QuotaList> {
            return AccountsApiFp(configuration).listQuotas(name, type, exceeded, enforced, page, perPage, options).then((request) => request(axios, basePath));
        },
    };
};
...
export interface AccountsApiListQuotasRequest {
    ...
    /**
     * Whether to return only quotas which are exceeded
     * @type {boolean}
     * @memberof AccountsApiListQuotas
     */
...
export class AccountsApi extends BaseAPI {
    ...
    public listQuotas(requestParameters: AccountsApiListQuotasRequest, options?: any) {
        return AccountsApiFp(this.configuration).listQuotas(requestParameters.name, requestParameters.type, requestParameters.exceeded, requestParameters.enforced, requestParameters.page, requestParameters.perPage, options).then((request) => request(this.axios, this.basePath));
    }
}
