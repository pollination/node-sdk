...
export const AccountsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        listAccounts: async (page?: number, perPage?: number, search?: string, type?: string, role?: RoleEnum, options: any = {}): Promise<RequestArgs> => {
...
export const AccountsApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async listAccounts(page?: number, perPage?: number, search?: string, type?: string, role?: RoleEnum, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<PublicAccountList>> {
            const localVarAxiosArgs = await AccountsApiAxiosParamCreator(configuration).listAccounts(page, perPage, search, type, role, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
export const AccountsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        listAccounts(page?: number, perPage?: number, search?: string, type?: string, role?: RoleEnum, options?: any): AxiosPromise<PublicAccountList> {
            return AccountsApiFp(configuration).listAccounts(page, perPage, search, type, role, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class AccountsApi extends BaseAPI implements AccountsApiInterface {
     ...
     * @memberof AccountsApi
     */
    public listAccounts(page?: number, perPage?: number, search?: string, type?: string, role?: RoleEnum, options?: any) {
        return AccountsApiFp(this.configuration).listAccounts(page, perPage, search, type, role, options).then((request) => request(this.axios, this.basePath));
    }
}
