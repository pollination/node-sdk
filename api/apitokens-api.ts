...
export class APITokensApi extends BaseAPI implements APITokensApiInterface {
    ...
    public deleteToken(tokenId: string, options?: any) {
        return APITokensApiFp(this.configuration).deleteToken(tokenId, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof APITokensApi
     */
    public regenerateToken(tokenId: string, options?: any) {
        return APITokensApiFp(this.configuration).regenerateToken(tokenId, options).then((request) => request(this.axios, this.basePath));
    }
}
