...
// @ts-ignore
import { CreateTokenDto } from '../models';
// @ts-ignore
...
// @ts-ignore
import { PrivateUserDto } from '../models';
// @ts-ignore
...
export const UserApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        upsertRefreshToken: async (createTokenDto: CreateTokenDto, options: any = {}): Promise<RequestArgs> => {
...
export const UserApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async getMe(options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<PrivateUserDto>> {
         ...
         * @throws {RequiredError}
         */
        async listRefreshTokens(options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<RefreshTokenDto>>> {
         ...
         * @throws {RequiredError}
         */
        async login(loginDto: LoginDto, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<LoginToken>> {
            const localVarAxiosArgs = await UserApiAxiosParamCreator(configuration).login(loginDto, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        async signup(signUpDto: SignUpDto, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<any>> {
            const localVarAxiosArgs = await UserApiAxiosParamCreator(configuration).signup(signUpDto, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        async upsertRefreshToken(createTokenDto: CreateTokenDto, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<string>> {
            const localVarAxiosArgs = await UserApiAxiosParamCreator(configuration).upsertRefreshToken(createTokenDto, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
export const UserApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
        ...
        login(loginDto: LoginDto, options?: any): AxiosPromise<LoginToken> {
            return UserApiFp(configuration).login(loginDto, options).then((request) => request(axios, basePath));
        },
        /**
         * Sign Up a new user
         * @summary Sign Up to the platform!
        ...
        signup(signUpDto: SignUpDto, options?: any): AxiosPromise<any> {
            return UserApiFp(configuration).signup(signUpDto, options).then((request) => request(axios, basePath));
        },
        /**
         * Get refresh token and delete previous one if it exists
         * @summary Get refresh token and delete previous one if it exists
        ...
        upsertRefreshToken(createTokenDto: CreateTokenDto, options?: any): AxiosPromise<string> {
            return UserApiFp(configuration).upsertRefreshToken(createTokenDto, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class UserApi extends BaseAPI implements UserApiInterface {
    ...
    public signup(signUpDto: SignUpDto, options?: any) {
        return UserApiFp(this.configuration).signup(signUpDto, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public upsertRefreshToken(createTokenDto: CreateTokenDto, options?: any) {
        return UserApiFp(this.configuration).upsertRefreshToken(createTokenDto, options).then((request) => request(this.axios, this.basePath));
    }
}
