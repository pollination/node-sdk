...
export class UserApi extends BaseAPI implements UserApiInterface {
     ...
     * @memberof UserApi
     */
    public updateUserProfile(userUpdate: UserUpdate, options?: any) {
        return UserApiFp(this.configuration).updateUserProfile(userUpdate, options).then((request) => request(this.axios, this.basePath));
    }
}
