...
export const TeamsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        listOrgTeams: async (orgName: string, page?: number, perPage?: number, search?: Array<string>, name?: Array<string>, member?: Array<string>, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'orgName' is not null or undefined
            if (orgName === null || orgName === undefined) {
...
export const TeamsApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async listOrgTeams(orgName: string, page?: number, perPage?: number, search?: Array<string>, name?: Array<string>, member?: Array<string>, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<TeamList>> {
            const localVarAxiosArgs = await TeamsApiAxiosParamCreator(configuration).listOrgTeams(orgName, page, perPage, search, name, member, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
export const TeamsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        listOrgTeams(orgName: string, page?: number, perPage?: number, search?: Array<string>, name?: Array<string>, member?: Array<string>, options?: any): AxiosPromise<TeamList> {
            return TeamsApiFp(configuration).listOrgTeams(orgName, page, perPage, search, name, member, options).then((request) => request(axios, basePath));
        },
        /**
         * Update a team (must have team or org `owner` role)
         * @summary Update a Team
...
export class TeamsApi extends BaseAPI implements TeamsApiInterface {
     ...
     * @memberof TeamsApi
     */
    public listOrgTeams(orgName: string, page?: number, perPage?: number, search?: Array<string>, name?: Array<string>, member?: Array<string>, options?: any) {
        return TeamsApiFp(this.configuration).listOrgTeams(orgName, page, perPage, search, name, member, options).then((request) => request(this.axios, this.basePath));
    }
