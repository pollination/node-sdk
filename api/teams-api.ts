...
export const TeamsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        upsertOrgTeamMember: async (orgName: string, teamSlug: string, username: string, role: 'owner' | 'member', options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'orgName' is not null or undefined
            if (orgName === null || orgName === undefined) {
...
export const TeamsApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async upsertOrgTeamMember(orgName: string, teamSlug: string, username: string, role: 'owner' | 'member', options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<UpdateAccepted>> {
