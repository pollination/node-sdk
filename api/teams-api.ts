...
export class TeamsApi extends BaseAPI implements TeamsApiInterface {
     ...
     * @memberof TeamsApi
     */
    public listOrgTeams(orgName: string, search?: Array<string>, name?: Array<string>, member?: Array<string>, page?: number, perPage?: number, options?: any) {
        return TeamsApiFp(this.configuration).listOrgTeams(orgName, search, name, member, page, perPage, options).then((request) => request(this.axios, this.basePath));
    }
