...
export const ApplicationsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        restartApplicationDeployment: async (owner: string, slug: string, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'owner' is not null or undefined
            if (owner === null || owner === undefined) {
         ...
         * @throws {RequiredError}
         */
        uploadVersionPackage: async (owner: string, slug: string, tag: string, file: File, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'owner' is not null or undefined
            if (owner === null || owner === undefined) {
                throw new RequiredError('owner','Required parameter owner was null or undefined when calling uploadVersionPackage.');
            }
            // verify required parameter 'slug' is not null or undefined
            if (slug === null || slug === undefined) {
                throw new RequiredError('slug','Required parameter slug was null or undefined when calling uploadVersionPackage.');
            }
            // verify required parameter 'tag' is not null or undefined
            if (tag === null || tag === undefined) {
                throw new RequiredError('tag','Required parameter tag was null or undefined when calling uploadVersionPackage.');
            }
            // verify required parameter 'file' is not null or undefined
            if (file === null || file === undefined) {
                throw new RequiredError('file','Required parameter file was null or undefined when calling uploadVersionPackage.');
            }
            const localVarPath = `/applications/{owner}/{slug}/versions/{tag}`
                .replace(`{${"owner"}}`, encodeURIComponent(String(owner)))
                .replace(`{${"slug"}}`, encodeURIComponent(String(slug)))
...
export const ApplicationsApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async restartApplicationDeployment(owner: string, slug: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<any>> {
            const localVarAxiosArgs = await ApplicationsApiAxiosParamCreator(configuration).restartApplicationDeployment(owner, slug, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        async uploadVersionPackage(owner: string, slug: string, tag: string, file: File, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<any>> {
            const localVarAxiosArgs = await ApplicationsApiAxiosParamCreator(configuration).uploadVersionPackage(owner, slug, tag, file, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
export const ApplicationsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        restartApplicationDeployment(owner: string, slug: string, options?: any): AxiosPromise<any> {
            return ApplicationsApiFp(configuration).restartApplicationDeployment(owner, slug, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary Update a Application
         ...
         * @throws {RequiredError}
         */
        uploadVersionPackage(owner: string, slug: string, tag: string, file: File, options?: any): AxiosPromise<any> {
            return ApplicationsApiFp(configuration).uploadVersionPackage(owner, slug, tag, file, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary Upsert a new permission to a application
...
export class ApplicationsApi extends BaseAPI {
     ...
     * @memberof ApplicationsApi
     */
    public restartApplicationDeployment(requestParameters: ApplicationsApiRestartApplicationDeploymentRequest, options?: any) {
     ...
     * @memberof ApplicationsApi
     */
    public uploadVersionPackage(requestParameters: ApplicationsApiUploadVersionPackageRequest, options?: any) {
