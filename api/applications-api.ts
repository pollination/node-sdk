...
export const ApplicationsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        listApplications: async (search?: string, ids?: Array<string>, names?: Array<string>, owner?: Array<string>, _public?: boolean, permissions?: Array<string>, sortBy?: ApplicationSortKey, sortOrder?: SortEnum, page?: number, perPage?: number, options: any = {}): Promise<RequestArgs> => {
...
export const ApplicationsApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async listApplications(search?: string, ids?: Array<string>, names?: Array<string>, owner?: Array<string>, _public?: boolean, permissions?: Array<string>, sortBy?: ApplicationSortKey, sortOrder?: SortEnum, page?: number, perPage?: number, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ApplicationList>> {
            const localVarAxiosArgs = await ApplicationsApiAxiosParamCreator(configuration).listApplications(search, ids, names, owner, _public, permissions, sortBy, sortOrder, page, perPage, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
export const ApplicationsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        listApplications(search?: string, ids?: Array<string>, names?: Array<string>, owner?: Array<string>, _public?: boolean, permissions?: Array<string>, sortBy?: ApplicationSortKey, sortOrder?: SortEnum, page?: number, perPage?: number, options?: any): AxiosPromise<ApplicationList> {
            return ApplicationsApiFp(configuration).listApplications(search, ids, names, owner, _public, permissions, sortBy, sortOrder, page, perPage, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary Update a Application
