...
export class OrgsApi extends BaseAPI implements OrgsApiInterface {
     ...
     * @memberof OrgsApi
     */
    public listOrgs(search?: Array<string>, name?: Array<string>, member?: Array<string>, page?: number, perPage?: number, options?: any) {
        return OrgsApiFp(this.configuration).listOrgs(search, name, member, page, perPage, options).then((request) => request(this.axios, this.basePath));
    }
