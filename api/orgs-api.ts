...
// @ts-ignore
import { OrgDto } from '../models';
// @ts-ignore
import { OrgMemberDto } from '../models';
// @ts-ignore
import { OrgRoleEnum } from '../models';
// @ts-ignore
import { PatchOrgDto } from '../models';
// @ts-ignore
...
export const OrgsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        createOrg: async (createOrgDto: CreateOrgDto, options: any = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        listOrgs: async (page?: number, perPage?: number, name?: Array<string>, member?: Array<string>, options: any = {}): Promise<RequestArgs> => {
            const localVarPath = `/orgs`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, 'https://example.com');
            let baseOptions;
         ...
         * @throws {RequiredError}
         */
        updateOrg: async (name: string, patchOrgDto: PatchOrgDto, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'name' is not null or undefined
            if (name === null || name === undefined) {
         ...
         * @throws {RequiredError}
         */
        upsertOrgMember: async (name: string, username: string, role: OrgRoleEnum, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'name' is not null or undefined
            if (name === null || name === undefined) {
...
export const OrgsApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async createOrg(createOrgDto: CreateOrgDto, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CreatedContent>> {
            const localVarAxiosArgs = await OrgsApiAxiosParamCreator(configuration).createOrg(createOrgDto, options);
         ...
         * @throws {RequiredError}
         */
        async getOrg(name: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<OrgDto>> {
         ...
         * @throws {RequiredError}
         */
        async getOrgMembers(name: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<OrgMemberDto>>> {
         ...
         * @throws {RequiredError}
         */
        async listOrgs(page?: number, perPage?: number, name?: Array<string>, member?: Array<string>, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<OrgDto>>> {
            const localVarAxiosArgs = await OrgsApiAxiosParamCreator(configuration).listOrgs(page, perPage, name, member, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        async updateOrg(name: string, patchOrgDto: PatchOrgDto, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<UpdateAccepted>> {
            const localVarAxiosArgs = await OrgsApiAxiosParamCreator(configuration).updateOrg(name, patchOrgDto, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        async upsertOrgMember(name: string, username: string, role: OrgRoleEnum, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<UpdateAccepted>> {
...
export const OrgsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
        ...
        createOrg(createOrgDto: CreateOrgDto, options?: any): AxiosPromise<CreatedContent> {
            return OrgsApiFp(configuration).createOrg(createOrgDto, options).then((request) => request(axios, basePath));
        },
        /**
         * Delete a org (must have `admin` permission)
         * @summary Delete an Org
        ...
        listOrgs(page?: number, perPage?: number, name?: Array<string>, member?: Array<string>, options?: any): AxiosPromise<Array<OrgDto>> {
            return OrgsApiFp(configuration).listOrgs(page, perPage, name, member, options).then((request) => request(axios, basePath));
        },
        /**
         * Update a org (must have org `owner` role)
         * @summary Update an Org
        ...
        updateOrg(name: string, patchOrgDto: PatchOrgDto, options?: any): AxiosPromise<UpdateAccepted> {
            return OrgsApiFp(configuration).updateOrg(name, patchOrgDto, options).then((request) => request(axios, basePath));
        },
        /**
         * Upsert a member role to the org (must have org `owner` role)
         * @summary Add or update the role of an Org Member
...
export class OrgsApi extends BaseAPI implements OrgsApiInterface {
    ...
    public createOrg(createOrgDto: CreateOrgDto, options?: any) {
        return OrgsApiFp(this.configuration).createOrg(createOrgDto, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public deleteOrg(name: string, options?: any) {
        return OrgsApiFp(this.configuration).deleteOrg(name, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public deleteOrgMember(name: string, username: string, options?: any) {
        return OrgsApiFp(this.configuration).deleteOrgMember(name, username, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public getOrg(name: string, options?: any) {
        return OrgsApiFp(this.configuration).getOrg(name, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public getOrgMembers(name: string, options?: any) {
        return OrgsApiFp(this.configuration).getOrgMembers(name, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public listOrgs(page?: number, perPage?: number, name?: Array<string>, member?: Array<string>, options?: any) {
        return OrgsApiFp(this.configuration).listOrgs(page, perPage, name, member, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public updateOrg(name: string, patchOrgDto: PatchOrgDto, options?: any) {
        return OrgsApiFp(this.configuration).updateOrg(name, patchOrgDto, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public upsertOrgMember(name: string, username: string, role: OrgRoleEnum, options?: any) {
        return OrgsApiFp(this.configuration).upsertOrgMember(name, username, role, options).then((request) => request(this.axios, this.basePath));
    }
}
