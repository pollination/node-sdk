...
export const OrgsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        upsertOrgMember: async (name: string, username: string, role: 'owner' | 'member', options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'name' is not null or undefined
            if (name === null || name === undefined) {
...
export const OrgsApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async listOrgs(page?: number, perPage?: number, name?: Array<string>, member?: Array<string>, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<OrganizationList>> {
         ...
         * @throws {RequiredError}
         */
        async upsertOrgMember(name: string, username: string, role: 'owner' | 'member', options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<UpdateAccepted>> {
...
export const OrgsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        listOrgs(page?: number, perPage?: number, name?: Array<string>, member?: Array<string>, options?: any): AxiosPromise<OrganizationList> {
