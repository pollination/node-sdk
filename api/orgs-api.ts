...
export const OrgsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        getOrgMembers: async (name: string, page?: number, perPage?: number, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'name' is not null or undefined
            if (name === null || name === undefined) {
         ...
         * @throws {RequiredError}
         */
        listOrgs: async (page?: number, perPage?: number, search?: Array<string>, name?: Array<string>, member?: Array<string>, options: any = {}): Promise<RequestArgs> => {
            const localVarPath = `/orgs`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, 'https://example.com');
            let baseOptions;
...
export const OrgsApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async getOrgMembers(name: string, page?: number, perPage?: number, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<OrganizationMemberList>> {
            const localVarAxiosArgs = await OrgsApiAxiosParamCreator(configuration).getOrgMembers(name, page, perPage, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        async listOrgs(page?: number, perPage?: number, search?: Array<string>, name?: Array<string>, member?: Array<string>, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<OrganizationList>> {
            const localVarAxiosArgs = await OrgsApiAxiosParamCreator(configuration).listOrgs(page, perPage, search, name, member, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
export const OrgsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        getOrgMembers(name: string, page?: number, perPage?: number, options?: any): AxiosPromise<OrganizationMemberList> {
            return OrgsApiFp(configuration).getOrgMembers(name, page, perPage, options).then((request) => request(axios, basePath));
        },
        /**
         * search for orgs using query parameters
         * @summary List Orgs
         ...
         * @throws {RequiredError}
         */
        listOrgs(page?: number, perPage?: number, search?: Array<string>, name?: Array<string>, member?: Array<string>, options?: any): AxiosPromise<OrganizationList> {
            return OrgsApiFp(configuration).listOrgs(page, perPage, search, name, member, options).then((request) => request(axios, basePath));
        },
        /**
         * Update a org (must have org `owner` role)
         * @summary Update an Org
...
export class OrgsApi extends BaseAPI implements OrgsApiInterface {
     ...
     * @memberof OrgsApi
     */
    public createOrg(organizationCreate: OrganizationCreate, options?: any) {
        return OrgsApiFp(this.configuration).createOrg(organizationCreate, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof OrgsApi
     */
    public getOrgMembers(name: string, page?: number, perPage?: number, options?: any) {
        return OrgsApiFp(this.configuration).getOrgMembers(name, page, perPage, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof OrgsApi
     */
    public listOrgs(page?: number, perPage?: number, search?: Array<string>, name?: Array<string>, member?: Array<string>, options?: any) {
        return OrgsApiFp(this.configuration).listOrgs(page, perPage, search, name, member, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof OrgsApi
     */
    public updateOrg(name: string, organizationUpdate: OrganizationUpdate, options?: any) {
        return OrgsApiFp(this.configuration).updateOrg(name, organizationUpdate, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof OrgsApi
     */
    public upsertOrgMember(name: string, username: string, role: OrganizationRoleEnum, options?: any) {
