...
export const RunsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        retryRun: async (owner: string, name: string, runId: string, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'owner' is not null or undefined
            if (owner === null || owner === undefined) {
...
export const RunsApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async retryRun(owner: string, name: string, runId: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<any>> {
            const localVarAxiosArgs = await RunsApiAxiosParamCreator(configuration).retryRun(owner, name, runId, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
export const RunsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        retryRun(owner: string, name: string, runId: string, options?: any): AxiosPromise<any> {
            return RunsApiFp(configuration).retryRun(owner, name, runId, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class RunsApi extends BaseAPI {
    ...
    public retryRun(requestParameters: RunsApiRetryRunRequest, options?: any) {
        return RunsApiFp(this.configuration).retryRun(requestParameters.owner, requestParameters.name, requestParameters.runId, options).then((request) => request(this.axios, this.basePath));
    }
}
