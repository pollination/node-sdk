...
export const RunsApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async listRunArtifacts(owner: string, name: string, runId: string, path?: Array<string>, page?: number, perPage?: number, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<any>> {
...
export const RunsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        listRunArtifacts(owner: string, name: string, runId: string, path?: Array<string>, page?: number, perPage?: number, options?: any): AxiosPromise<any> {
