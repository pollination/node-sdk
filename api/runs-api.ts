...
export class RunsApi extends BaseAPI implements RunsApiInterface {
     ...
     * @memberof RunsApi
     */
    public listRunArtifacts(owner: string, name: string, runId: string, path?: Array<string>, page?: number, perPage?: number, options?: any) {
        return RunsApiFp(this.configuration).listRunArtifacts(owner, name, runId, path, page, perPage, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof RunsApi
     */
    public listRuns(owner: string, name: string, jobId?: Array<string>, status?: RunStatusEnum, page?: number, perPage?: number, options?: any) {
        return RunsApiFp(this.configuration).listRuns(owner, name, jobId, status, page, perPage, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof RunsApi
     */
    public queryResults(owner: string, name: string, jobId?: Array<string>, status?: RunStatusEnum, page?: number, perPage?: number, options?: any) {
        return RunsApiFp(this.configuration).queryResults(owner, name, jobId, status, page, perPage, options).then((request) => request(this.axios, this.basePath));
    }
}
