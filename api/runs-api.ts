...
export const RunsApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async retryRun(owner: string, name: string, runId: string, retryConfig: RetryConfig, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<any>> {
...
export const RunsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        retryRun(owner: string, name: string, runId: string, retryConfig: RetryConfig, options?: any): AxiosPromise<any> {
