...
export const RunsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        getAllRunSteps: async (owner: string, name: string, runId: string, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'owner' is not null or undefined
            if (owner === null || owner === undefined) {
         ...
         * @throws {RequiredError}
         */
        retryRun: async (owner: string, name: string, runId: string, retryConfig: RetryConfig, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'owner' is not null or undefined
            if (owner === null || owner === undefined) {
...
export const RunsApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async cancelRun(owner: string, name: string, runId: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Run>> {
         ...
         * @throws {RequiredError}
         */
        async downloadRunArtifact(owner: string, name: string, runId: string, path?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<string>> {
         ...
         * @throws {RequiredError}
         */
        async getAllRunSteps(owner: string, name: string, runId: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<StepStatus>>> {
            const localVarAxiosArgs = await RunsApiAxiosParamCreator(configuration).getAllRunSteps(owner, name, runId, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        async listRunArtifacts(owner: string, name: string, runId: string, path?: Array<string>, page?: number, perPage?: number, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<FileMetaList>> {
         ...
         * @throws {RequiredError}
         */
        async retryRun(owner: string, name: string, runId: string, retryConfig: RetryConfig, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Run>> {
            const localVarAxiosArgs = await RunsApiAxiosParamCreator(configuration).retryRun(owner, name, runId, retryConfig, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
export const RunsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        cancelRun(owner: string, name: string, runId: string, options?: any): AxiosPromise<Run> {
         ...
         * @throws {RequiredError}
         */
        downloadRunArtifact(owner: string, name: string, runId: string, path?: string, options?: any): AxiosPromise<string> {
         ...
         * @throws {RequiredError}
         */
        getAllRunSteps(owner: string, name: string, runId: string, options?: any): AxiosPromise<Array<StepStatus>> {
            return RunsApiFp(configuration).getAllRunSteps(owner, name, runId, options).then((request) => request(axios, basePath));
        },
        /**
         * Retrieve a run.
         * @summary Get a Run
         ...
         * @throws {RequiredError}
         */
        listRunArtifacts(owner: string, name: string, runId: string, path?: Array<string>, page?: number, perPage?: number, options?: any): AxiosPromise<FileMetaList> {
         ...
         * @throws {RequiredError}
         */
        retryRun(owner: string, name: string, runId: string, retryConfig: RetryConfig, options?: any): AxiosPromise<Run> {
            return RunsApiFp(configuration).retryRun(owner, name, runId, retryConfig, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class RunsApi extends BaseAPI {
     ...
     * @memberof RunsApi
     */
    public getAllRunSteps(requestParameters: RunsApiGetAllRunStepsRequest, options?: any) {
     ...
     * @memberof RunsApi
     */
    public retryRun(requestParameters: RunsApiRetryRunRequest, options?: any) {
