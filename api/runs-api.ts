...
export const RunsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        listRuns: async (owner: string, name: string, status?: RunStatusEnum, jobId?: Array<string>, page?: number, perPage?: number, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'owner' is not null or undefined
            if (owner === null || owner === undefined) {
         ...
         * @throws {RequiredError}
         */
        queryResults: async (owner: string, name: string, status?: RunStatusEnum, jobId?: Array<string>, page?: number, perPage?: number, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'owner' is not null or undefined
            if (owner === null || owner === undefined) {
...
export const RunsApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async listRuns(owner: string, name: string, status?: RunStatusEnum, jobId?: Array<string>, page?: number, perPage?: number, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<RunList>> {
         ...
         * @throws {RequiredError}
         */
        async queryResults(owner: string, name: string, status?: RunStatusEnum, jobId?: Array<string>, page?: number, perPage?: number, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<RunResultList>> {
...
export const RunsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        listRuns(owner: string, name: string, status?: RunStatusEnum, jobId?: Array<string>, page?: number, perPage?: number, options?: any): AxiosPromise<RunList> {
         ...
         * @throws {RequiredError}
         */
        queryResults(owner: string, name: string, status?: RunStatusEnum, jobId?: Array<string>, page?: number, perPage?: number, options?: any): AxiosPromise<RunResultList> {
...
export class RunsApi extends BaseAPI implements RunsApiInterface {
     ...
     * @memberof RunsApi
     */
    public cancelRun(owner: string, name: string, runId: string, options?: any) {
        return RunsApiFp(this.configuration).cancelRun(owner, name, runId, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof RunsApi
     */
    public getRunSteps(owner: string, name: string, runId: string, status?: StepStatusEnum, stepId?: Array<string>, untilGeneration?: string, sinceGeneration?: string, page?: number, perPage?: number, options?: any) {
     ...
     * @memberof RunsApi
     */
    public listRuns(owner: string, name: string, status?: RunStatusEnum, jobId?: Array<string>, page?: number, perPage?: number, options?: any) {
     ...
     * @memberof RunsApi
     */
    public queryResults(owner: string, name: string, status?: RunStatusEnum, jobId?: Array<string>, page?: number, perPage?: number, options?: any) {
