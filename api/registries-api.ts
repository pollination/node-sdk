...
export class RegistriesApi extends BaseAPI implements RegistriesApiInterface {
     ...
     * @memberof RegistriesApi
     */
    public postRecipe(owner: string, _package: any, options?: any) {
        return RegistriesApiFp(this.configuration).postRecipe(owner, _package, options).then((request) => request(this.axios, this.basePath));
    }
}
