...
// @ts-ignore
import { ResponseGetPackageJson } from '../models';
/**
...
export const RegistriesApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        postPlugin: async (owner: string, _package: File, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'owner' is not null or undefined
            if (owner === null || owner === undefined) {
         ...
         * @throws {RequiredError}
         */
        postRecipe: async (owner: string, _package: File, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'owner' is not null or undefined
            if (owner === null || owner === undefined) {
...
export const RegistriesApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async getPackageJson(owner: string, type: string, name: string, digest: string, baked?: boolean, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ResponseGetPackageJson>> {
         ...
         * @throws {RequiredError}
         */
        async postPlugin(owner: string, _package: File, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<any>> {
         ...
         * @throws {RequiredError}
         */
        async postRecipe(owner: string, _package: File, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<any>> {
...
export const RegistriesApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        getPackageJson(owner: string, type: string, name: string, digest: string, baked?: boolean, options?: any): AxiosPromise<ResponseGetPackageJson> {
         ...
         * @throws {RequiredError}
         */
        postPlugin(owner: string, _package: File, options?: any): AxiosPromise<any> {
         ...
         * @throws {RequiredError}
         */
        postRecipe(owner: string, _package: File, options?: any): AxiosPromise<any> {
