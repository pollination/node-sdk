...
export const RegistriesApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        postOperator: async (owner: string, _package: any, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'owner' is not null or undefined
            if (owner === null || owner === undefined) {
...
export const RegistriesApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async getPackage(owner: string, type: string, name: string, digest: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<object>> {
         ...
         * @throws {RequiredError}
         */
        async postOperator(owner: string, _package: any, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<object>> {
            const localVarAxiosArgs = await RegistriesApiAxiosParamCreator(configuration).postOperator(owner, _package, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        async postRecipe(owner: string, _package: any, authorization?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<object>> {
...
export const RegistriesApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        getPackage(owner: string, type: string, name: string, digest: string, options?: any): AxiosPromise<object> {
        ...
        postOperator(owner: string, _package: any, options?: any): AxiosPromise<object> {
            return RegistriesApiFp(configuration).postOperator(owner, _package, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary Push an Recipe to the registry
...
export class RegistriesApi extends BaseAPI implements RegistriesApiInterface {
    ...
    public postOperator(owner: string, _package: any, options?: any) {
        return RegistriesApiFp(this.configuration).postOperator(owner, _package, options).then((request) => request(this.axios, this.basePath));
    }
