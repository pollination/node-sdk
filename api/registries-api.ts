...
export class RegistriesApi extends BaseAPI {
    ...
    public getPackageJson(requestParameters: RegistriesApiGetPackageJsonRequest, options?: any) {
        return RegistriesApiFp(this.configuration).getPackageJson(requestParameters.owner, requestParameters.type, requestParameters.name, requestParameters.digest, options).then((request) => request(this.axios, this.basePath));
    }
