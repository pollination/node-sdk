...
export const RecipesApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        listRecipeTags: async (owner: string, name: string, page?: number, perPage?: number, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'owner' is not null or undefined
            if (owner === null || owner === undefined) {
...
export const RecipesApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async listRecipeTags(owner: string, name: string, page?: number, perPage?: number, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<RecipePackageList>> {
            const localVarAxiosArgs = await RecipesApiAxiosParamCreator(configuration).listRecipeTags(owner, name, page, perPage, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
export const RecipesApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        listRecipeTags(owner: string, name: string, page?: number, perPage?: number, options?: any): AxiosPromise<RecipePackageList> {
            return RecipesApiFp(configuration).listRecipeTags(owner, name, page, perPage, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary List recipes
...
export class RecipesApi extends BaseAPI implements RecipesApiInterface {
     ...
     * @memberof RecipesApi
     */
    public listRecipeTags(owner: string, name: string, page?: number, perPage?: number, options?: any) {
        return RecipesApiFp(this.configuration).listRecipeTags(owner, name, page, perPage, options).then((request) => request(this.axios, this.basePath));
    }
