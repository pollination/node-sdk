...
export const RecipesApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @summary Get a recipe\'s access permissions
         * @param {string} owner 
         * @param {string} name 
         ...
         * @throws {RequiredError}
         */
        listRecipes: async (page?: number, perPage?: number, name?: Array<string>, owner?: Array<string>, _public?: boolean, keyword?: Array<string>, permission?: Array<string>, options: any = {}): Promise<RequestArgs> => {
...
export const RecipesApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async listRecipes(page?: number, perPage?: number, name?: Array<string>, owner?: Array<string>, _public?: boolean, keyword?: Array<string>, permission?: Array<string>, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<RepositoryList>> {
            const localVarAxiosArgs = await RecipesApiAxiosParamCreator(configuration).listRecipes(page, perPage, name, owner, _public, keyword, permission, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
export const RecipesApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        listRecipes(page?: number, perPage?: number, name?: Array<string>, owner?: Array<string>, _public?: boolean, keyword?: Array<string>, permission?: Array<string>, options?: any): AxiosPromise<RepositoryList> {
            return RecipesApiFp(configuration).listRecipes(page, perPage, name, owner, _public, keyword, permission, options).then((request) => request(axios, basePath));
        },
        /**
         * Update a recipe (must have `contribute` permission)
         * @summary Update a Recipe
...
export class RecipesApi extends BaseAPI implements RecipesApiInterface {
     ...
     * @memberof RecipesApi
     */
    public listRecipes(page?: number, perPage?: number, name?: Array<string>, owner?: Array<string>, _public?: boolean, keyword?: Array<string>, permission?: Array<string>, options?: any) {
        return RecipesApiFp(this.configuration).listRecipes(page, perPage, name, owner, _public, keyword, permission, options).then((request) => request(this.axios, this.basePath));
    }
