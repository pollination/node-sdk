...
export class RecipesApi extends BaseAPI implements RecipesApiInterface {
     ...
     * @memberof RecipesApi
     */
    public listRecipes(search?: Array<string>, name?: Array<string>, owner?: Array<string>, _public?: boolean, keyword?: Array<string>, permission?: Array<string>, sortBy?: RepositorySortKey, sortOrder?: SortEnum, page?: number, perPage?: number, options?: any) {
        return RecipesApiFp(this.configuration).listRecipes(search, name, owner, _public, keyword, permission, sortBy, sortOrder, page, perPage, options).then((request) => request(this.axios, this.basePath));
    }
