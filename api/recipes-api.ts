...
export const RecipesApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        listRecipeTags: async (owner: string, name: string, page?: number, perPage?: number, sortBy?: PackageSortKey, sortOrder?: SortEnum, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'owner' is not null or undefined
            if (owner === null || owner === undefined) {
         ...
         * @throws {RequiredError}
         */
        listRecipes: async (page?: number, perPage?: number, search?: Array<string>, name?: Array<string>, owner?: Array<string>, _public?: boolean, keyword?: Array<string>, permission?: Array<string>, sortBy?: RepositorySortKey, sortOrder?: SortEnum, options: any = {}): Promise<RequestArgs> => {
...
export const RecipesApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async listRecipeTags(owner: string, name: string, page?: number, perPage?: number, sortBy?: PackageSortKey, sortOrder?: SortEnum, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<RecipePackageList>> {
            const localVarAxiosArgs = await RecipesApiAxiosParamCreator(configuration).listRecipeTags(owner, name, page, perPage, sortBy, sortOrder, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        async listRecipes(page?: number, perPage?: number, search?: Array<string>, name?: Array<string>, owner?: Array<string>, _public?: boolean, keyword?: Array<string>, permission?: Array<string>, sortBy?: RepositorySortKey, sortOrder?: SortEnum, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<RepositoryList>> {
            const localVarAxiosArgs = await RecipesApiAxiosParamCreator(configuration).listRecipes(page, perPage, search, name, owner, _public, keyword, permission, sortBy, sortOrder, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
export const RecipesApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        listRecipeTags(owner: string, name: string, page?: number, perPage?: number, sortBy?: PackageSortKey, sortOrder?: SortEnum, options?: any): AxiosPromise<RecipePackageList> {
            return RecipesApiFp(configuration).listRecipeTags(owner, name, page, perPage, sortBy, sortOrder, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary List recipes
         ...
         * @throws {RequiredError}
         */
        listRecipes(page?: number, perPage?: number, search?: Array<string>, name?: Array<string>, owner?: Array<string>, _public?: boolean, keyword?: Array<string>, permission?: Array<string>, sortBy?: RepositorySortKey, sortOrder?: SortEnum, options?: any): AxiosPromise<RepositoryList> {
            return RecipesApiFp(configuration).listRecipes(page, perPage, search, name, owner, _public, keyword, permission, sortBy, sortOrder, options).then((request) => request(axios, basePath));
        },
        /**
         * Update a recipe (must have `contribute` permission)
         * @summary Update a Recipe
...
export class RecipesApi extends BaseAPI implements RecipesApiInterface {
     ...
     * @memberof RecipesApi
     */
    public createRecipePackage(owner: string, name: string, newRecipePackage: NewRecipePackage, options?: any) {
        return RecipesApiFp(this.configuration).createRecipePackage(owner, name, newRecipePackage, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof RecipesApi
     */
    public listRecipeTags(owner: string, name: string, page?: number, perPage?: number, sortBy?: PackageSortKey, sortOrder?: SortEnum, options?: any) {
        return RecipesApiFp(this.configuration).listRecipeTags(owner, name, page, perPage, sortBy, sortOrder, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof RecipesApi
     */
    public listRecipes(page?: number, perPage?: number, search?: Array<string>, name?: Array<string>, owner?: Array<string>, _public?: boolean, keyword?: Array<string>, permission?: Array<string>, sortBy?: RepositorySortKey, sortOrder?: SortEnum, options?: any) {
        return RecipesApiFp(this.configuration).listRecipes(page, perPage, search, name, owner, _public, keyword, permission, sortBy, sortOrder, options).then((request) => request(this.axios, this.basePath));
    }
