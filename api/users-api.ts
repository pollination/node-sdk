...
export const UsersApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {Array<string>} [username] Username of the user to search for
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        listUsers: async (page?: number, perPage?: number, username?: Array<string>, options: any = {}): Promise<RequestArgs> => {
...
export const UsersApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async listUsers(page?: number, perPage?: number, username?: Array<string>, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<UserPublicList>> {
            const localVarAxiosArgs = await UsersApiAxiosParamCreator(configuration).listUsers(page, perPage, username, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
export const UsersApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        listUsers(page?: number, perPage?: number, username?: Array<string>, options?: any): AxiosPromise<UserPublicList> {
            return UsersApiFp(configuration).listUsers(page, perPage, username, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class UsersApi extends BaseAPI implements UsersApiInterface {
     ...
     * @memberof UsersApi
     */
    public listUsers(page?: number, perPage?: number, username?: Array<string>, options?: any) {
        return UsersApiFp(this.configuration).listUsers(page, perPage, username, options).then((request) => request(this.axios, this.basePath));
    }
}
