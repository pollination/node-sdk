...
export const ProjectsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        getProjectRecipes: async (owner: string, name: string, page?: number, perPage?: number, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'owner' is not null or undefined
            if (owner === null || owner === undefined) {
...
export const ProjectsApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async getProjectRecipes(owner: string, name: string, page?: number, perPage?: number, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<RepositoryList>> {
            const localVarAxiosArgs = await ProjectsApiAxiosParamCreator(configuration).getProjectRecipes(owner, name, page, perPage, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
export const ProjectsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        getProjectRecipes(owner: string, name: string, page?: number, perPage?: number, options?: any): AxiosPromise<RepositoryList> {
            return ProjectsApiFp(configuration).getProjectRecipes(owner, name, page, perPage, options).then((request) => request(axios, basePath));
        },
        /**
         * search for projects using query parameters
         * @summary List Projects
...
export class ProjectsApi extends BaseAPI implements ProjectsApiInterface {
     ...
     * @memberof ProjectsApi
     */
    public getProjectRecipes(owner: string, name: string, page?: number, perPage?: number, options?: any) {
        return ProjectsApiFp(this.configuration).getProjectRecipes(owner, name, page, perPage, options).then((request) => request(this.axios, this.basePath));
    }
