...
export const ProjectsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        getProjectRecipeRepositories: async (owner: string, name: string, search?: string, page?: number, perPage?: number, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'owner' is not null or undefined
            if (owner === null || owner === undefined) {
...
export const ProjectsApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async getProjectRecipeRepositories(owner: string, name: string, search?: string, page?: number, perPage?: number, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<RepositoryList>> {
            const localVarAxiosArgs = await ProjectsApiAxiosParamCreator(configuration).getProjectRecipeRepositories(owner, name, search, page, perPage, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
export const ProjectsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        getProjectRecipeRepositories(owner: string, name: string, search?: string, page?: number, perPage?: number, options?: any): AxiosPromise<RepositoryList> {
            return ProjectsApiFp(configuration).getProjectRecipeRepositories(owner, name, search, page, perPage, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary Get project recipe versions
...
export class ProjectsApi extends BaseAPI {
     ...
     * @memberof ProjectsApi
     */
    public getProjectRecipeRepositories(requestParameters: ProjectsApiGetProjectRecipeRepositoriesRequest, options?: any) {
