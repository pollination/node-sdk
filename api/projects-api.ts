...
export class ProjectsApi extends BaseAPI implements ProjectsApiInterface {
     ...
     * @memberof ProjectsApi
     */
    public listProjects(search?: string, ids?: Array<string>, names?: Array<string>, owner?: Array<string>, _public?: boolean, permissions?: Array<string>, sortBy?: ProjectSortKey, sortOrder?: SortEnum, page?: number, perPage?: number, options?: any) {
        return ProjectsApiFp(this.configuration).listProjects(search, ids, names, owner, _public, permissions, sortBy, sortOrder, page, perPage, options).then((request) => request(this.axios, this.basePath));
    }
