...
export const ProjectsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        listProjects: async (page?: number, perPage?: number, id?: Array<string>, name?: Array<string>, owner?: Array<string>, _public?: boolean, permission?: Array<string>, options: any = {}): Promise<RequestArgs> => {
...
export const ProjectsApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async listProjects(page?: number, perPage?: number, id?: Array<string>, name?: Array<string>, owner?: Array<string>, _public?: boolean, permission?: Array<string>, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ProjectList>> {
            const localVarAxiosArgs = await ProjectsApiAxiosParamCreator(configuration).listProjects(page, perPage, id, name, owner, _public, permission, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
export const ProjectsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        listProjects(page?: number, perPage?: number, id?: Array<string>, name?: Array<string>, owner?: Array<string>, _public?: boolean, permission?: Array<string>, options?: any): AxiosPromise<ProjectList> {
            return ProjectsApiFp(configuration).listProjects(page, perPage, id, name, owner, _public, permission, options).then((request) => request(axios, basePath));
        },
        /**
         * Update a project (must have `contribute` permission)
         * @summary Update a Project
...
export class ProjectsApi extends BaseAPI implements ProjectsApiInterface {
     ...
     * @memberof ProjectsApi
     */
    public listProjects(page?: number, perPage?: number, id?: Array<string>, name?: Array<string>, owner?: Array<string>, _public?: boolean, permission?: Array<string>, options?: any) {
        return ProjectsApiFp(this.configuration).listProjects(page, perPage, id, name, owner, _public, permission, options).then((request) => request(this.axios, this.basePath));
    }
