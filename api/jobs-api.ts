...
export const JobsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        createJob: async (owner: string, name: string, job: Job, authorization?: string, options: any = {}): Promise<RequestArgs> => {
...
export const JobsApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async createJob(owner: string, name: string, job: Job, authorization?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CreatedContent>> {
            const localVarAxiosArgs = await JobsApiAxiosParamCreator(configuration).createJob(owner, name, job, authorization, options);
...
export const JobsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        createJob(owner: string, name: string, job: Job, authorization?: string, options?: any): AxiosPromise<CreatedContent> {
            return JobsApiFp(configuration).createJob(owner, name, job, authorization, options).then((request) => request(axios, basePath));
        },
        /**
         * Get a download link for an artifact in a job folder
         * @summary Download an artifact from the job folder
...
export class JobsApi extends BaseAPI implements JobsApiInterface {
     ...
     * @memberof JobsApi
     */
    public createJob(owner: string, name: string, job: Job, authorization?: string, options?: any) {
        return JobsApiFp(this.configuration).createJob(owner, name, job, authorization, options).then((request) => request(this.axios, this.basePath));
    }
