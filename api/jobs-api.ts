...
export const JobsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        retryJob: async (owner: string, name: string, jobId: string, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'owner' is not null or undefined
            if (owner === null || owner === undefined) {
...
export const JobsApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async retryJob(owner: string, name: string, jobId: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<any>> {
            const localVarAxiosArgs = await JobsApiAxiosParamCreator(configuration).retryJob(owner, name, jobId, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
export const JobsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        retryJob(owner: string, name: string, jobId: string, options?: any): AxiosPromise<any> {
            return JobsApiFp(configuration).retryJob(owner, name, jobId, options).then((request) => request(axios, basePath));
        },
        /**
         * Retrieve a list of artifacts in a job folder
         * @summary List files/folders in a job folder
...
export class JobsApi extends BaseAPI {
    ...
    public retryJob(requestParameters: JobsApiRetryJobRequest, options?: any) {
        return JobsApiFp(this.configuration).retryJob(requestParameters.owner, requestParameters.name, requestParameters.jobId, options).then((request) => request(this.axios, this.basePath));
    }
