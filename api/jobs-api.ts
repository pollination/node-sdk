...
export class JobsApi extends BaseAPI implements JobsApiInterface {
     ...
     * @memberof JobsApi
     */
    public cancelJob(owner: string, name: string, jobId: string, options?: any) {
        return JobsApiFp(this.configuration).cancelJob(owner, name, jobId, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof JobsApi
     */
    public listJobs(owner: string, name: string, ids?: Array<string>, status?: JobStatusEnum, page?: number, perPage?: number, options?: any) {
