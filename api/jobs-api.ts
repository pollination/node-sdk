...
export class JobsApi extends BaseAPI implements JobsApiInterface {
     ...
     * @memberof JobsApi
     */
    public searchJobFolder(owner: string, name: string, jobId: string, path?: Array<string>, page?: number, perPage?: number, options?: any) {
        return JobsApiFp(this.configuration).searchJobFolder(owner, name, jobId, path, page, perPage, options).then((request) => request(this.axios, this.basePath));
    }
}
