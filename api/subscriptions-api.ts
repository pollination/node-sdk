...
export const SubscriptionsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        getUpcomingPollinationSubscription: async (accountName: string, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'accountName' is not null or undefined
            if (accountName === null || accountName === undefined) {
                throw new RequiredError('accountName','Required parameter accountName was null or undefined when calling getUpcomingPollinationSubscription.');
            }
            const localVarPath = `/subscriptions/{account_name}/upcoming`
                .replace(`{${"account_name"}}`, encodeURIComponent(String(accountName)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, 'https://example.com');
            let baseOptions;
...
export const SubscriptionsApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async getUpcomingPollinationSubscription(accountName: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<PollinationSubscription>> {
            const localVarAxiosArgs = await SubscriptionsApiAxiosParamCreator(configuration).getUpcomingPollinationSubscription(accountName, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
export const SubscriptionsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        getUpcomingPollinationSubscription(accountName: string, options?: any): AxiosPromise<PollinationSubscription> {
            return SubscriptionsApiFp(configuration).getUpcomingPollinationSubscription(accountName, options).then((request) => request(axios, basePath));
        },
    };
};
...
/**
 * Request parameters for getUpcomingPollinationSubscription operation in SubscriptionsApi.
 * @export
 * @interface SubscriptionsApiGetUpcomingPollinationSubscriptionRequest
 */
export interface SubscriptionsApiGetUpcomingPollinationSubscriptionRequest {
    /**
     * 
     * @type {string}
     * @memberof SubscriptionsApiGetUpcomingPollinationSubscription
     */
    readonly accountName: string
}
...
export class SubscriptionsApi extends BaseAPI {
     ...
     * 
     * @summary Get Upcoming Subscription
     * @param {SubscriptionsApiGetUpcomingPollinationSubscriptionRequest} requestParameters Request parameters.
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof SubscriptionsApi
     */
    public getUpcomingPollinationSubscription(requestParameters: SubscriptionsApiGetUpcomingPollinationSubscriptionRequest, options?: any) {
        return SubscriptionsApiFp(this.configuration).getUpcomingPollinationSubscription(requestParameters.accountName, options).then((request) => request(this.axios, this.basePath));
    }
}
