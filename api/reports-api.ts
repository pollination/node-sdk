...
// @ts-ignore
import type { ReportOrganisationMemberUsage } from '../models';
/**
...
export const ReportsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        /**
         * Get compute usage report for an account
         * @summary Get organisation member usage report for an organization account
         * @param {string} name 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        getOrgMemberUsageReport: async (name: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            const localVarPath = `/reports/{name}/organisation-member-usage`
                .replace(`{${"name"}}`, encodeURIComponent(String(name)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
...
export const ReportsApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getOrgMemberUsageReport(name: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ReportOrganisationMemberUsage>> {
...
export const ReportsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getOrgMemberUsageReport(requestParameters: ReportsApiGetOrgMemberUsageReportRequest, options?: RawAxiosRequestConfig): AxiosPromise<ReportOrganisationMemberUsage> {
