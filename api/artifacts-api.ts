...
export const ArtifactsApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async listArtifacts(owner: string, name: string, path?: Array<string>, page?: number, perPage?: number, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<FileMeta>>> {
...
export const ArtifactsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        listArtifacts(owner: string, name: string, path?: Array<string>, page?: number, perPage?: number, options?: any): AxiosPromise<Array<FileMeta>> {
...
export class ArtifactsApi extends BaseAPI implements ArtifactsApiInterface {
     ...
     * @memberof ArtifactsApi
     */
    public deleteArtifact(owner: string, name: string, path?: Array<string>, page?: number, perPage?: number, options?: any) {
        return ArtifactsApiFp(this.configuration).deleteArtifact(owner, name, path, page, perPage, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof ArtifactsApi
     */
    public listArtifacts(owner: string, name: string, path?: Array<string>, page?: number, perPage?: number, options?: any) {
        return ArtifactsApiFp(this.configuration).listArtifacts(owner, name, path, page, perPage, options).then((request) => request(this.axios, this.basePath));
    }
}
