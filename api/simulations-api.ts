...
export const SimulationsApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async downloadSimulationArtifact(owner: string, name: string, simulationId: string, path?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<object>> {
         ...
         * @throws {RequiredError}
         */
        async getSimulationInputs(owner: string, name: string, simulationId: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<object>> {
         ...
         * @throws {RequiredError}
         */
        async getSimulationLogs(owner: string, name: string, simulationId: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<object>> {
         ...
         * @throws {RequiredError}
         */
        async getSimulationOutputArtifact(owner: string, name: string, simulationId: string, artifactName: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<object>> {
         ...
         * @throws {RequiredError}
         */
        async getSimulationOutputs(owner: string, name: string, simulationId: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<object>> {
...
export const SimulationsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        downloadSimulationArtifact(owner: string, name: string, simulationId: string, path?: string, options?: any): AxiosPromise<object> {
         ...
         * @throws {RequiredError}
         */
        getSimulationOutputArtifact(owner: string, name: string, simulationId: string, artifactName: string, options?: any): AxiosPromise<object> {
