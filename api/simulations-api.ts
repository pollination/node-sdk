...
// @ts-ignore
import { SubmitSimulationDto } from '../models';
/**
...
export const SimulationsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        createSimulation: async (owner: string, name: string, submitSimulationDto: SubmitSimulationDto, authorization?: string, options: any = {}): Promise<RequestArgs> => {
...
export const SimulationsApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async createSimulation(owner: string, name: string, submitSimulationDto: SubmitSimulationDto, authorization?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CreatedContent>> {
            const localVarAxiosArgs = await SimulationsApiAxiosParamCreator(configuration).createSimulation(owner, name, submitSimulationDto, authorization, options);
...
export const SimulationsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
        ...
        createSimulation(owner: string, name: string, submitSimulationDto: SubmitSimulationDto, authorization?: string, options?: any): AxiosPromise<CreatedContent> {
            return SimulationsApiFp(configuration).createSimulation(owner, name, submitSimulationDto, authorization, options).then((request) => request(axios, basePath));
        },
        /**
         * Get a download link for an artifact in a simulation folder
         * @summary Download an artifact from the simulation folder
...
export class SimulationsApi extends BaseAPI implements SimulationsApiInterface {
    ...
    public createSimulation(owner: string, name: string, submitSimulationDto: SubmitSimulationDto, authorization?: string, options?: any) {
        return SimulationsApiFp(this.configuration).createSimulation(owner, name, submitSimulationDto, authorization, options).then((request) => request(this.axios, this.basePath));
    }
