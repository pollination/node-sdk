...
export const SimulationsApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async getSimulation(owner: string, name: string, simulationId: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Simulation>> {
...
export const SimulationsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        getSimulation(owner: string, name: string, simulationId: string, options?: any): AxiosPromise<Simulation> {
