...
export const OperatorsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        listOperators: async (page?: number, perPage?: number, search?: Array<string>, name?: Array<string>, owner?: Array<string>, _public?: boolean, keyword?: Array<string>, permission?: Array<string>, options: any = {}): Promise<RequestArgs> => {
...
export const OperatorsApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async listOperators(page?: number, perPage?: number, search?: Array<string>, name?: Array<string>, owner?: Array<string>, _public?: boolean, keyword?: Array<string>, permission?: Array<string>, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<RepositoryList>> {
            const localVarAxiosArgs = await OperatorsApiAxiosParamCreator(configuration).listOperators(page, perPage, search, name, owner, _public, keyword, permission, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
export const OperatorsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        listOperators(page?: number, perPage?: number, search?: Array<string>, name?: Array<string>, owner?: Array<string>, _public?: boolean, keyword?: Array<string>, permission?: Array<string>, options?: any): AxiosPromise<RepositoryList> {
            return OperatorsApiFp(configuration).listOperators(page, perPage, search, name, owner, _public, keyword, permission, options).then((request) => request(axios, basePath));
        },
        /**
         * Update an operator (must have `contribute` permission)
         * @summary Update an Operator
...
export class OperatorsApi extends BaseAPI implements OperatorsApiInterface {
     ...
     * @memberof OperatorsApi
     */
    public listOperators(page?: number, perPage?: number, search?: Array<string>, name?: Array<string>, owner?: Array<string>, _public?: boolean, keyword?: Array<string>, permission?: Array<string>, options?: any) {
        return OperatorsApiFp(this.configuration).listOperators(page, perPage, search, name, owner, _public, keyword, permission, options).then((request) => request(this.axios, this.basePath));
    }
